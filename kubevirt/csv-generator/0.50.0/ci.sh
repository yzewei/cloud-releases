...
echo "start build---------------------------------"
	cd /build/kubevirt-0.50.0 && go build -o csv-generator tools/csv-generator/csv-generator.go
echo "start to cloud---------------------------------"
	cd /build/kubevirt-0.50.0 && bash /build/lib/curl.sh csv-generator kubevirt/csv-generator/ 0.50.0
