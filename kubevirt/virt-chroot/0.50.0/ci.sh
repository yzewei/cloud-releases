...
echo "start build---------------------------------"
	cd /build/kubevirt-0.50.0 && go build -o virt-chroot pkg/virt-handler/virt-chroot/virt-chroot.go
echo "start to cloud---------------------------------"
	cd /build/kubevirt-0.50.0 && bash /build/lib/curl.sh virt-chroot kubevirt/virt-chroot 0.50.0
