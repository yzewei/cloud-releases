...
echo "start build---------------------------------"
	cd /build/kubevirt-0.50.0 && go build -o virt-operator cmd/virt-operator/virt-operator.go
echo "start to cloud---------------------------------"
	cd /build/kubevirt-0.50.0 && bash /build/lib/curl.sh virt-operator kubevirt/virt-operator 0.50.0
